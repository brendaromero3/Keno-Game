...
The game begins on the welcome screen. Here the player can read a short description of the game. Additonally, they are able to choose between beginning the game by clicking the start button and 3 menu options. The first menu option is the rules button where the player is able to read the rules of the game. Next is the Winning Odds option where the player can view the odds of winning in correlation to the amount of spots. Lastly is the exit option, which allows the player to go back to the welcome screen. This exit option is only clickable when the player is not within the welcome screen.

After the player clicks the start button, they are able to begin playing. Here the menu options work a bit differenttly. Firstly, there is a new menu option: New Look. When this option is clicked, the look of the game changes! While playing, when a player clicks the rules or winning odds options, they are taken to their respective screens. Here, the start button will take the player back to the game, right where they left off. If the player chooses to click the exit button, they will be taken to the welcome screen. Now the start button will take them to a new game, rather than the game they were currently playing. 

Now onto the actual game! On the game screen, the player can see buttons to choose the amount of spots they would like, choose the amount of drawings, pick random spots, start, and the actual spot buttons. Though they are not all available to be clicked yet. The player must first choose the amount of spots they would like to choose. Upon making their choice, the player can now choose the amount of drawings they would like to play. Next, they are able to start choosing their spots or can choose to randomize their spots. They can only choose spots up to the amount that they chose. If at any time they want their spots to be randomized, upon clicking the button, all spots that were previously chosen will be unclicked. Now the random spots will be chosen. After all the spots are chosen, the player can click the start button to move onto the drawings.
